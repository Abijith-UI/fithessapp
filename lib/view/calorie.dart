...
import 'package:flutter_fitness_1/common/calorietheme.dart';
        ...
        body: SingleChildScrollView(
          child:
            ...
            Row(
              ...
              children: [
                Text("Calorie Calculator", style: apptheme.titleText),
              ],
            ),
            SizedBox(
              height: 10,
            ),
            Text("Find out the exact amount of calories you need.",
                style: apptheme.labelText),
            SizedBox(
              height: 10,
            ),
            Text("Take control of your daily calorie intake.",
                style: apptheme.labelText),
            SizedBox(
              height: 20,
            ),
            ...
            Visibility(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Our diet plans offer advices that can help you ",
                    style: apptheme.labelText,
                  ),
                  Text(
