...
class _ScheduleViewState extends State<ScheduleView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 181, 74, 235),
        centerTitle: true,
        elevation: 0.1,
        leading: IconButton(
            onPressed: () {
          ...
          children: [
            ...
            Padding(
              ...
              child: Stack(
                children: [
                  CalendarCarousel(
                    todayButtonColor: Color.fromARGB(255, 203, 85, 250),
                    todayBorderColor: Color.fromARGB(255, 250, 143, 85),
                    selectedDayButtonColor: Color.fromARGB(255, 220, 85, 250),
                    selectedDayBorderColor: Color.fromARGB(255, 195, 85, 250),
                    ...
                    daysTextStyle: TextStyle(
                        color: Color.fromARGB(255, 18, 7, 1),
                        fontSize: 16,
                        fontWeight: FontWeight.w700),
                    ...
                    weekendTextStyle: TextStyle(
                        color: Color.fromARGB(255, 250, 143, 85),
                        fontSize: 16,
                        fontWeight: FontWeight.w700),
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              InkWell(
                onTap: () {},
                child: Image.asset("images/menu_meal_plan.png",
                    width: 25, height: 25),
              ),
              InkWell(
                onTap: () {},
              ...
              InkWell(
                onTap: () {},
                child:
                    Image.asset("images/menu_home.png", width: 25, height: 25),
              ),
              InkWell(
                onTap: () {
                  Navigator.push(
                ...
                child: Image.asset("images/menu_weight.png",
                    width: 25, height: 25),
              ),
              InkWell(
                onTap: () {},
                child: Image.asset("images/more.png", width: 25, height: 25),
              ),
            ],
          ),
        ),
